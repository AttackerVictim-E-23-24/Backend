...
public class UserService extends BaseService
{
    ...
    @GET
    @Path( "/recPassword/{usuario}/{codigo}/{password}/" )
    public ServiceResponse recuperarPassword(@PathParam( "usuario" ) String usuario, @PathParam( "codigo" ) int codigo, @PathParam( "password" ) String password){
